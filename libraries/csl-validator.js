var CSLValidator = (function() {
    ...
    function validate() {
        ...
        */
        ...
        if (schemaVersion == 'EAD3') {
          ...
          var schemaURL = "https://raw.githubusercontent.com/SAA-SDT/eac-cpf-schema/release/v2.0-draft/xml-schemas/eac-cpf/eac.rng https://raw.githubusercontent.com/SAA-SDT/eac-cpf-schema/release/v2.0-draft/xml-schemas/eac-cpf/schematron/eac.sch";
          ...
          var schemaURL = "https://raw.githubusercontent.com/SAA-SDT/eac-cpf-schema/pre-revision-files/cpf.rng";
        }
    ...
    function parseResponse(data) {
        ...
        if (nonDocumentError !== "") {
            ...
            $("#alert").append('<div class="inserted alert alert-success" role="alert">Good job! No errors found.</br><small>Interested in contributing to TS-EAS? See our <a href="https://github.com/SAA-SDT/eac-cpf-schema/blob/development/CONTRIBUTING.md">instructions</a>.</small></div>');
        } else if (errorCount > 0) {
            if (errorCount == 1) {
            ...
            $("#alert > div.alert-danger").append('</br><small>If you have trouble understanding the error messages below, start by checking out the <a href="https://eac.staatsbibliothek-berlin.de/schemata-and-tag-library/">EAC-CPF specification</a> or the <a href="https://www.loc.gov/ead/">EAD specification</a> .</small>');
